...
- **Store file rename**: every standalone-Tachi SQLite file renames `memory.db` -> `tachi-memory.db` on first open, leaving a symlink for this release window (#1132, details under Changed).
