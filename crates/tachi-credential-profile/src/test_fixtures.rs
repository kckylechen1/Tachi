//! NOTE (#1610 Track T): a verbatim copy of tachi-server's
//! `utils/test_fixtures.rs`. Accepted duplication for the FIRST carve only —
//! the trigger to extract a shared test-support leaf is the THIRD copy, i.e.
//! the second carve. Contract weight is "a unique scratch dir path"; drift here
//! is not correctness-bearing.
