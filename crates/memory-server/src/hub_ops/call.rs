...
pub(crate) const SIMULATED_SKILL_OUTPUT_MARKER: &str =
    "[SIMULATED — LLM-generated skill output. No commands, files, or tests were executed.]";

pub(crate) const SIMULATED_SKILL_OUTPUT_WARNING: &str = "This output was generated by a language model from the skill's prompt template. It did not execute commands or read the repository. Do not treat concrete values (commit hashes, line numbers, test results, file paths) as verified facts.";
...
pub(crate) struct SkillExecution {
    ...
    pub(crate) execution: SkillExecutionMode,
}
...
pub(crate) fn build_skill_execution_envelope(
    skill_id: &str,
