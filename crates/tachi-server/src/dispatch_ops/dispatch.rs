...
use self::authority::{
    assert_grant_legacy_projection, compile_dispatch_contract, contract_receipt,
...
pub(crate) async fn handle_tachi_dispatch(
    ...
    // than identity-bound delivery — this is a pre-existing property of
    ...
    write_status_json(
        ...
        Some(json!({
            ...
            "cwd": execution_grant.allowed_cwd.clone(),
