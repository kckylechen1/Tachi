...
//!   4. the canonical Task WorkClaim lifecycle and the legacy presence
//!      release hook used by terminal dispatch paths.
//!
...
/// as colliding with itself. Falls back to board-only (empty scope, no
