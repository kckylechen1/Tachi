...
use tachi_foundry::{
    build_daily_distill_candidate_groups, should_skip_daily_distill_candidate, CandidateGroup,
};

use crate::foundry_runtime_ops::FOUNDRY_DISTILL_SOURCE;

use super::config::{resolve_candidate_scan_limit, resolve_processed_scan_limit};
...
pub(crate) fn collect_candidate_groups(
    ...
    Ok(build_daily_distill_candidate_groups(candidate_entries))
}
