...
async fn sandbox_check_respects_access_rules() {
    ...
    server
        ...
        .await
        .expect("tachi_sandbox(action='set_rule') should succeed");
    ...
    let check_read = server
        ...
        .await
        .expect("tachi_sandbox(action='check') should succeed");
...
async fn sandbox_set_rule_updates_existing_rule() {
    ...
    server
        ...
        .await
        .expect("tachi_sandbox(action='set_rule') update should succeed");
