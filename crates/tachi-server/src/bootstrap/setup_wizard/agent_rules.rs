...
- Call `tachi_memory` with `action=\"briefing\"` (or `tachi_task` `action=\"briefing\"`).\n\
...
- Treat `cycle_status` as read-only navigation; follow its `next_action`, blockers, and readiness flags.\n\n\
