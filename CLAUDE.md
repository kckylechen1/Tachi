...
- **Mechanical chores** (long test suites, cargo builds, git/PR plumbing): the `Oz` agent on `sonnet`, content authored by the leader verbatim — Oz never authors conclusions.
