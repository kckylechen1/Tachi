...
```bash
curl -fsSL https://raw.githubusercontent.com/kckylechen1/tachi/v1.7.0/scripts/install.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/kckylechen1/tachi/v1.7.0/scripts/install_openclaw_ext.sh | bash
```
